...
class MiczoneCatalogStorageService_getSliceProduct_args
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Miczone\Thrift\Catalog\Product\GetSliceProductRequest',
        ),
    );
    ...
    /**
     * @var \Miczone\Thrift\Catalog\Product\GetSliceProductRequest
     */
    public $request = null;
    ...
    {
        return 'MiczoneCatalogStorageService_getSliceProduct_args';
    }
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->request = new \Miczone\Thrift\Catalog\Product\GetSliceProductRequest();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MiczoneCatalogStorageService_getSliceProduct_args');
