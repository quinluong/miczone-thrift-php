...
class MiczoneCatalogStorageServiceClient implements \Miczone\Thrift\Catalog\MiczoneCatalogStorageServiceIf
{
    ...
    {
        $args = new \Miczone\Thrift\Catalog\MiczoneCatalogStorageService_getCategoryByOriginalCategoryOriginalId_args();
        $args->operationHandle = $operationHandle;
        $args->request = $request;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_getCategoryByOriginalCategoryOriginalId()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\Miczone\Thrift\Catalog\MiczoneCatalogStorageService_getCategoryByOriginalCategoryOriginalId_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \Miczone\Thrift\Catalog\MiczoneCatalogStorageService_getCategoryByOriginalCategoryOriginalId_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
