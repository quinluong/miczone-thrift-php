...
class GetSliceCategoryResponseDataItemOriginalCategory
{
    ...
    {
        return 'GetSliceCategoryResponseDataItemOriginalCategory';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('GetSliceCategoryResponseDataItemOriginalCategory');
        ...
        if ($this->source !== null) {
            ...
            $xfer += $output->writeFieldBegin('source', TType::STRUCT, 3);
            $xfer += $this->source->write($output);
            $xfer += $output->writeFieldEnd();
        }
        if ($this->originalId !== null) {
            $xfer += $output->writeFieldBegin('originalId', TType::STRING, 4);
