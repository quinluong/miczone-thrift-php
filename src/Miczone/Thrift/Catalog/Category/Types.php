      ...
      switch ($fid)
      {
        ...
        case 13:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Miczone\Thrift\Catalog\OriginalCategory\SimpleOriginalCategory();
              $xfer += $elem5->read($input);
              $this->originalCategoryList []= $elem5;
            }
  ...
  public function write($output) {
    ...
    if ($this->originalCategoryList !== null) {
      ...
      $xfer += $output->writeFieldBegin('originalCategoryList', TType::LST, 13);
      {
        ...
        {
          foreach ($this->originalCategoryList as $iter6)
          {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::MAP) {
            ...
            {
              $key19 = '';
              $val20 = new \Miczone\Thrift\Catalog\Category\Category();
              $xfer += $input->readString($key19);
              $val20 = new \Miczone\Thrift\Catalog\Category\Category();
              $xfer += $val20->read($input);
              $this->dataMap[$key19] = $val20;
            }
  ...
  public function write($output) {
    ...
    if ($this->dataMap !== null) {
      ...
      $xfer += $output->writeFieldBegin('dataMap', TType::MAP, 3);
      {
        ...
        {
          foreach ($this->dataMap as $kiter21 => $viter22)
          {
  ...
  public function write($output) {
    ...
    if ($this->slugList !== null) {
      ...
      $xfer += $output->writeFieldBegin('slugList', TType::LST, 1);
      {
        ...
        {
          foreach ($this->slugList as $iter29)
          {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::MAP) {
            ...
            {
              $key35 = '';
              $val36 = new \Miczone\Thrift\Catalog\Category\Category();
              $xfer += $input->readString($key35);
              $val36 = new \Miczone\Thrift\Catalog\Category\Category();
              $xfer += $val36->read($input);
              $this->dataMap[$key35] = $val36;
            }
            $xfer += $input->readMapEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->dataMap !== null) {
      ...
      $xfer += $output->writeFieldBegin('dataMap', TType::MAP, 3);
      {
        $output->writeMapBegin(TType::STRING, TType::STRUCT, count($this->dataMap));
        {
          foreach ($this->dataMap as $kiter37 => $viter38)
          {
