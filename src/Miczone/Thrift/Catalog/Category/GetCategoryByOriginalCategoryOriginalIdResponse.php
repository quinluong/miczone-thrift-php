...
class GetCategoryByOriginalCategoryOriginalIdResponse
{
    ...
    {
        return 'GetCategoryByOriginalCategoryOriginalIdResponse';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('GetCategoryByOriginalCategoryOriginalIdResponse');
        if ($this->error !== null) {
