...
class GetCategoryByOriginalCategoryResponse
{
    ...
    {
        return 'GetCategoryByOriginalCategoryResponse';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('GetCategoryByOriginalCategoryResponse');
        if ($this->error !== null) {
