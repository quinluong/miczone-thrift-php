...
class MiczoneCatalogStorageService_getSliceCategory_args
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Miczone\Thrift\Catalog\Category\GetSliceCategoryRequest',
        ),
    );
    ...
    /**
     * @var \Miczone\Thrift\Catalog\Category\GetSliceCategoryRequest
     */
    public $request = null;
    ...
    {
        return 'MiczoneCatalogStorageService_getSliceCategory_args';
    }
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->request = new \Miczone\Thrift\Catalog\Category\GetSliceCategoryRequest();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MiczoneCatalogStorageService_getSliceCategory_args');
