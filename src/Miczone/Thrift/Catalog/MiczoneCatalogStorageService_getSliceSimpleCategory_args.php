...
class MiczoneCatalogStorageService_getSliceSimpleCategory_args
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Miczone\Thrift\Catalog\Category\GetSliceSimpleCategoryRequest',
        ),
    );
    ...
    /**
     * @var \Miczone\Thrift\Catalog\Category\GetSliceSimpleCategoryRequest
     */
    public $request = null;
    ...
    {
        return 'MiczoneCatalogStorageService_getSliceSimpleCategory_args';
    }
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->request = new \Miczone\Thrift\Catalog\Category\GetSliceSimpleCategoryRequest();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MiczoneCatalogStorageService_getSliceSimpleCategory_args');
