...
class MultiGetBreadcrumbListByProductSkuAndOriginalMerchantRequestItem
{
    ...
    {
        return 'MultiGetBreadcrumbListByProductSkuAndOriginalMerchantRequestItem';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MultiGetBreadcrumbListByProductSkuAndOriginalMerchantRequestItem');
