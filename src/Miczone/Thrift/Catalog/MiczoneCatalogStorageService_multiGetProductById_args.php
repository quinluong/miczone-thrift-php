...
class MiczoneCatalogStorageService_multiGetProductById_args
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Miczone\Thrift\Catalog\Product\MultiGetProductByIdRequest',
        ),
    );
    ...
    /**
     * @var \Miczone\Thrift\Catalog\Product\MultiGetProductByIdRequest
     */
    public $request = null;
    ...
    {
        return 'MiczoneCatalogStorageService_multiGetProductById_args';
    }
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->request = new \Miczone\Thrift\Catalog\Product\MultiGetProductByIdRequest();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MiczoneCatalogStorageService_multiGetProductById_args');
