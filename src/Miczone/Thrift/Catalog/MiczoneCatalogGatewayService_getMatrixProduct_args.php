...
class MiczoneCatalogGatewayService_getMatrixProduct_args
{
    ...
    static public $_TSPEC = array(
        ...
        2 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\Miczone\Thrift\Catalog\Product\GetMatrixProductRequest',
        ),
    );
    ...
    /**
     * @var \Miczone\Thrift\Catalog\Product\GetMatrixProductRequest
     */
    public $request = null;
    ...
    {
        return 'MiczoneCatalogGatewayService_getMatrixProduct_args';
    }
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->request = new \Miczone\Thrift\Catalog\Product\GetMatrixProductRequest();
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MiczoneCatalogGatewayService_getMatrixProduct_args');
