...
class MultiGetProductTranslatedNameByProductSkuAndOriginalMerchantRequestItem
{
    ...
    {
        return 'MultiGetProductTranslatedNameByProductSkuAndOriginalMerchantRequestItem';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MultiGetProductTranslatedNameByProductSkuAndOriginalMerchantRequestItem');
