...
class MultiGetProductTranslatedNameByProductSkuAndOriginalMerchantResponse
{
    ...
    {
        return 'MultiGetProductTranslatedNameByProductSkuAndOriginalMerchantResponse';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MultiGetProductTranslatedNameByProductSkuAndOriginalMerchantResponse');
        if ($this->error !== null) {
        ...
        if ($this->dataMap !== null) {
            ...
            foreach ($this->dataMap as $kiter39 => $viter40) {
