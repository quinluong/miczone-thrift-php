...
class MultiGetSimpleProductByIdListRequest
{
    ...
    {
        return 'MultiGetSimpleProductByIdListRequest';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MultiGetSimpleProductByIdListRequest');
        if ($this->idList !== null) {
