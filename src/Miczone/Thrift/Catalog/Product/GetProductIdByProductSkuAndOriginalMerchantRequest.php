...
class GetProductIdByProductSkuAndOriginalMerchantRequest
{
    ...
    {
        return 'GetProductIdByProductSkuAndOriginalMerchantRequest';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('GetProductIdByProductSkuAndOriginalMerchantRequest');
