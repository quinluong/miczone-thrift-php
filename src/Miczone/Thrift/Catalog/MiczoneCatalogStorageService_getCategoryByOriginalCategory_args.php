...
class MiczoneCatalogStorageService_getCategoryByOriginalCategory_args
{
    ...
    {
        return 'MiczoneCatalogStorageService_getCategoryByOriginalCategory_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('MiczoneCatalogStorageService_getCategoryByOriginalCategory_args');
